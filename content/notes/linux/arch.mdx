...
Considering:
- replacing fullgaps with [ru_gaps](https://dwm.suckless.org/patches/ru_gaps/) for more custom layouts support (i.e. [Fibonacci](https://dwm.suckless.org/patches/fibonacci/))
