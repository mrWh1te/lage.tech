...
[Fullgaps](https://dwm.suckless.org/patches/fullgaps/) or [ru_gaps](https://dwm.suckless.org/patches/ru_gaps/)
- Decrease gap size
    - alt + -
- Increase gap size
    - alt + =
...
- Set to `Spiral` layout (similar to Tiled but Stack spirals)
    - alt + r
- Set to `Dwindle` layout (similar to Spiral but reverse direction)
    - alt + shift + R