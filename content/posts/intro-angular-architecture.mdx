...
date: 2019-04-15
tags: ["frontend", "UI", "architecture", "angular"]
excerpt: How to use value driven architecture in Application Development with an enterprise Redux example
---
...
Each one of these coding-patterns are found in ngLibrary. If you haven't checked it out yet, here is the [Demo](https://nglibrary-demo.netlify.com/). Don't forget to bookmark & star the source code on Github [right here](https://github.com/mrWh1te/ngLibrary)! I really appreciate it 🎇🙏😊
