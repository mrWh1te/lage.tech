...
People in tech are familiar with the classic iterative process of developing new features and fixing bugs: develop, deploy to Staging, receive feedback, then repeat.

<center>
    <img src="/iterative-development-loop.png" alt="Iterative Development Loop" />
</center>

This process has been proven thorough enough that it usually (if not consistently) delivers satisfactory results.

Now, with the emergence of powerful Documentation tools, from [Docz](https://www.docz.site/) to [Storybook](https://storybook.js.org/), comes an opportunity for frontend teams to shorten the development leg of this loop.
...
This is opposed to the UI first development approach, that reduces the developer's focus to *just* the UI layer. We can represent the number of iterations in code layers with such:
...
Traditionally you build a feature, deploy to Staging for review, than iterate as many times as needed before merging in.
