...
Realistically, by using this process, the number of times your developers need to rewrite component code reduces. With this process, developer throughput increases, not to mention, you now have an *amazing* resource of UI component Documentation.
