...
date: 2020-01-03
socialImage: ./ui-first-development-loop.png
tags: ["frontend", "UI", "process"]
excerpt: The math behind increasing FE developer throughput with UI first development that build documentation using popular tools such as Storybook or Docz
---
