...
As you see, the more complex the feature, the more exploratory the phase of development, the cheaper and more valuable it becomes, to iterate on the UI until completion, before ever considering the end business logic. The UI, after all, sets requirements for the business services to serve.
